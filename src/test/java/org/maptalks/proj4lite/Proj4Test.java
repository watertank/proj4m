...
public class Proj4Test {
    ...
    private static PointAdaptor<double[]> pointAdaptor = new PointAdaptor<double[]>() {
        ...
        public void setX(double[] point, double x) {
            point[0] = x;
        }

        public void setY(double[] point, double y) {
            point[1] = y;
        }
    };
    ...
    public void testForward() throws Exception {
        Proj4<double[]> proj = new Proj4<double[]>(EPSG4326, EPSG3857, pointAdaptor);
    ...
    public void testForwardWithDef() throws Exception {
        Proj4<double[]> proj = new Proj4<double[]>("EPSG:4326", "EPSG:3857", pointAdaptor);
        double[] coord = proj.forward(new double[] {120.0, 30.0});
        double tolerance = 1e-3;
        assertEquals(coord[0], 13358338.895192828, tolerance);
        assertEquals(coord[1], 3503549.843504374, tolerance);
    ...
    public void testForwardWithMixed() throws Exception {
        Proj4<double[]> proj = new Proj4<double[]>(EPSG4326, "EPSG:3857", pointAdaptor);
        double[] coord = proj.forward(new double[] {120.0, 30.0});
        double tolerance = 1e-3;
        assertEquals(coord[0], 13358338.895192828, tolerance);
        assertEquals(coord[1], 3503549.843504374, tolerance);
    ...
    public void testInverseWithMixed() throws Exception {
        Proj4<double[]> proj = new Proj4<double[]>("EPSG:4326", EPSG3857, pointAdaptor);
        double[] coord = proj.inverse(new double[] {13358338.89, 3503549.84});
        double tolerance = 1e-7;
        assertEquals(coord[0], 120.0, tolerance);
        assertEquals(coord[1], 30.0, tolerance);
    ...
    public void testSameProj() throws Exception {
        Proj4<double[]> proj = new Proj4<double[]>("GCJ02", "GCJ02");
    ...
    public void testGcj02ToBaidu() throws Exception {
        ...
        Proj4<double[]> proj = new Proj4<double[]>("GCJ02", "BD09LL", pointAdaptor);
    ...
    public void testProj4() throws Exception {
        ...
        Proj4<double[]> proj = new Proj4<double[]>(firstProjection, secondProjection, pointAdaptor);
